...
from gait_analysis.event.events import EventAnomalyChecker


class GaitCycle:

    def __init__(self, number, context, start_frame, end_frame):
        self.number = number
...
class CycleBuilder(ABC):
    ...
    def _build(self, acq: btkAcquisition) -> List[GaitCycle]:
        pass
